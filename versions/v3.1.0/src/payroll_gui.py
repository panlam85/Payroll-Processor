...
class PayrollProcessorGUI:
    ...
    def generate_reports(self, files_override=None, auto_trigger=False):
        ...
        timestamp = datetime.datetime.now().strftime('%Y%m%d_%H%M%S')
        summary_path = self.employee_reports_dir / f"employee_reports_{timestamp}_summary.xlsx"
        detail_path = self.employee_reports_dir / f"employee_reports_{timestamp}_detail.xlsx"
