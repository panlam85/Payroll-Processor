...
class PayrollProcessorGUI:
    ...
    def configure_styles(self):
        ...
        try:
            ...
            pass
        style.configure("App.TFrame", background="#f5f5f0")
        style.configure("Card.TFrame", background="#ffffff", relief="solid", borderwidth=1)
        style.configure("CardTitle.TLabel", background="#ffffff", foreground="#666666", font=("Avenir Next", 11))
        style.configure("CardValue.TLabel", background="#ffffff", foreground="#1a1a1a", font=("Avenir Next", 18, "bold"))
        style.configure("Header.TLabel", background="#f5f5f0", foreground="#1a1a1a", font=("Avenir Next", 16, "bold"))
        style.configure("Section.TLabel", background="#f5f5f0", foreground="#1a1a1a", font=("Avenir Next", 13, "bold"))
        style.configure("Body.TLabel", background="#f5f5f0", foreground="#333333", font=("Avenir Next", 11))
        style.configure("App.TLabelframe", background="#f5f5f0")
        style.configure("App.TLabelframe.Label", background="#f5f5f0", foreground="#1a1a1a", font=("Avenir Next", 11, "bold"))
